...
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],0);
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],1);
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],2);
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],3);
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],4);
addPoly([1,1,0,-1,1,0,-1,-1,0,1,-1,0],5);
addPoly([99,99,-29,-99,99,-29,-99,-99,-29,99,-99,-29],6);
...
var tex=[];
tex[0]=null;create_texture('pico.png',0);
tex[1]=null;create_texture('bg.jpg',1);
...
function disp()
{
	...
	m.lookAt([0,0,3],[0,0,0],[0,1,0],matV);
	...
	var p=vec3RotateZ(vec3RotateY(vec3RotateX([0,0,1],t),t),t);
	m.translate(uni_mat0,p,uni_mat0);
	gl.uniformMatrix4fv(gl.getUniformLocation(prg,'uni_mat0'),false,uni_mat0);

	gl.uniform1f(gl.getUniformLocation(prg,'uni_t_v'),t);
